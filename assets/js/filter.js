            ...
            $('.btn-projects').on('click', function () {
                $('.btn-projects-active').removeClass('btn-projects-active').addClass('btn-projects');
                $(this).removeClass('btn-projects').addClass('btn-projects-active');
            })

            $('.btn-projects-active').on('click', function () {
                $('.btn-projects-active').removeClass('btn-projects-active').addClass('btn-projects');
                $(this).removeClass('btn-projects').addClass('btn-projects-active');
